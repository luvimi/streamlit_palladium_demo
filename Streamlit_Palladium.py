...
pais = st.selectbox("País de Origen", options=['España', 'Alemania', 'Canadá', 'Estados Unidos', 'Francia', 'México', 'Reino Unido', 'Otro'])
hotel = st.selectbox("Hotel de Destino", options=['Palladium', 'Bless', 'Fiesta', 'Hard Rock Hotel', 'Mallorca Rocks', 'Sa Talaia', 'TRS', 'Ushuaia'])
